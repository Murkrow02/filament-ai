...
beforeEach(function (): void {
    config()->set('rag.llm.pricing', [
        'gpt-4o' => ['input' => 2.50, 'output' => 10.00],
        'gpt-4o-mini' => ['input' => 0.15, 'output' => 0.60],
        'claude-haiku-4-5' => ['input' => 1.00, 'output' => 5.00],
    ]);

    config()->set('rag.embeddings.pricing', ['text-embedding-3-small' => 0.02]);
});
...
it('never prices a smaller model as its bigger namesake', function (): void {
    ...
    expect(CostCalculator::priceKeyFor('rag.llm.pricing', 'gpt-4o-mini-2024-07-18'))->toBe('gpt-4o-mini')
        ->and(CostCalculator::priceKeyFor('rag.llm.pricing', 'gpt-4o-2024-11-20'))->toBe('gpt-4o');
});
...
it('charges nothing for a model nobody priced', function (): void {
    expect(CostCalculator::completionMicros('llama-3.1-70b', 1_000_000, 1_000_000))->toBe(0)
        ->and(CostCalculator::priceKeyFor('rag.llm.pricing', 'llama-3.1-70b'))->toBeNull();
});
